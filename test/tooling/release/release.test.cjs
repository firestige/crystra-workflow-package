...
test("workflow asset builder is deterministic and digest verified", async () => {
  ...
  assert.deepEqual(manifest.packages.map((item) => item.tag), [
    "crystra-workflow-package/hello-world-workflow/v0.2.0",
    "crystra-workflow-package/implementation-workflow/v0.4.12",
    "crystra-workflow-package/system-design-workflow/v0.4.10",
  ]);
